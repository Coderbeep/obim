...
contextBridge.exposeInMainWorld("api", {
  ...
  getFilesRecursiveAsList: (directoryPath) =>
    ipcRenderer.invoke("get-files-recursive-as-list", directoryPath),
  getFilesRecursiveAsTree: (directoryPath) =>
    ipcRenderer.invoke("get-files-recursive-as-tree", directoryPath),
