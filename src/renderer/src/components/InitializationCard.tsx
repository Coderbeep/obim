...
export const InitializationCard = () => {
    ...
    return (
        <div className="flex h-screen justify-center items-center select-none">
            <div className="flex flex-col w-[32em] h-[38em] rounded-xl bg-white 
                ...
                <div className="flex justify-between items-end w-full">
                    <div className="flex flex-col">
                        ...
                        <span className="text-sm text-gray-500">Select directory for your markdown notes</span>
                    </div>
                    <button onClick={handleOnClick} className="bg-blue-500 text-white font-normal text-sm px-4 py-1 rounded-md">
                        Select
                    </button>
                </div>
            </div>
